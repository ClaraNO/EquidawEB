...
public class ServletVentes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Clara
       if(url.equals("/EquidaWeb20/ServletVentes/listerLesMails"))
        
        {  
            String venteId77 = (String)request.getParameter("codeVente99");
            
            ArrayList<Mail> lesMails = VenteDAO.getLesMails(connection, venteId77);
            System.out.println("TEST" +lesMails.size() );
            request.setAttribute("pLesMails555", lesMails);
            getServletContext().getRequestDispatcher("/vues/ventes/listerLesMails.jsp").forward(request, response);
        }
